...
namespace ConferenceAPI.Controllers
{
    ...
    public class ConferenceDocumentController : ControllerBase
    {
        ...
        [HttpGet]
        [Route("GetDocumentsBydocumentID")]
        public ActionResult<IResponse> GetDocumentsBydocumentID(int documentID)
        {
            ...
            if (user != null)
            {
                ...
                List<DocumentUserEN> User = _conferenceDocumentBL.GetDocumentsBydocumentID(user.UserID, documentID);
