    ...
    public class UserDAL
    {
        ...
        public async Task<List<InstitutionDetailsEN>> GetInstitutionsByUserAsync(int userId)
        {
            try
            {
                ...
                var institutionList = institutions.Select(i => new InstitutionDetailsEN
                {
                    InstitutionID = i.InstitutionID,
                    Name = i.Name,
                    Website = i.Website,
                    ContactPhone = i.ContactPhone,  // Nota el uso de 'contact_phone' en lugar de 'ContactPhone'
        ...
        public int InsertNewInstitutionByUser(int userID, InstitutionDetailsEN institution)
        {
            try
            {
                ...
                string query = "INSERT INTO institution (Name, Website, contact_phone, Description, UserID)  VALUES (@Name, @Website, @ContactPhone, @Description, @UserID);   SELECT LAST_INSERT_ID();";  // Esto devolverá el ID del registro insertado
